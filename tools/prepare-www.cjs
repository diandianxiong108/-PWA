...
safeClearDir(out);
for(const name of ['index.html','ai-memory.js','v2.js','v2.css','homev2-shell.js','homev2-shell.css','manifest.json','version.json','sw.js','quick-add.html','小猫图标.jpg','小猫图标（2）.jpg','小猫图标（3）.jpg','小猫图标（4）.jpg'])fs.copyFileSync(path.join(root,name),path.join(out,name));
